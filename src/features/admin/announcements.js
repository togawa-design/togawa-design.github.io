...
function renderAnnouncementsTable() {
  ...
  tbody.innerHTML = filtered.map(announcement => {
    ...
    return `
      <tr data-id="${escapeHtml(announcement.id)}">
        <td>
        ...
        <td class="actions-cell">
          <button class="btn-icon btn-edit" data-id="${escapeHtml(announcement.id)}" title="編集">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
              <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
            </svg>
          </button>
          <button class="btn-icon btn-delete" data-id="${escapeHtml(announcement.id)}" title="削除">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
