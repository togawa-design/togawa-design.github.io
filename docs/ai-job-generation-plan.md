...
求人文章生成以外にも活用できるAI機能をまとめる。

### 1. 求人関連（優先度: 高）

| 機能 | 説明 | 効果 |
|------|------|------|
| **説明文生成** | 職種・条件から文章生成 | 作成時間短縮 |
| **タイトル最適化** | CTR高いタイトル提案 | 応募率UP |
| **給与相場提案** | 地域・職種から相場を提示 | 競争力のある求人 |
| **必須スキル抽出** | 説明文から要件を自動抽出 | 入力漏れ防止 |

### 2. LP/採用ページ（優先度: 高）

| 機能 | 説明 | 効果 |
|------|------|------|
| **キャッチコピー生成** | ファーストビュー用の文言 | 離脱率改善 |
| **ポイント文言生成** | 「この求人の魅力」を自動作成 | 訴求力UP |
| **FAQ自動生成** | 求人内容からよくある質問を生成 | 問い合わせ削減 |
| **CTAボタン文言** | 「今すぐ応募」以外の候補提案 | CVR改善 |

### 3. 応募者対応（優先度: 中）

| 機能 | 説明 | 効果 |
|------|------|------|
| **返信メール生成** | 応募者への返信テンプレート | 対応時間短縮 |
| **面接質問提案** | 職種に合った質問リスト | 面接品質向上 |
| **不採用理由文** | 丁寧な不採用通知文の生成 | ブランド維持 |
| **日程調整文** | 面接日程の案内文生成 | 事務効率化 |

### 4. 分析・レポート（優先度: 中）

| 機能 | 説明 | 効果 |
|------|------|------|
| **レポート要約** | アナリティクスデータの要点抽出 | 意思決定支援 |
| **改善提案** | 「応募率を上げるには」を提案 | PDCAサイクル |
| **競合分析** | 同職種の他社求人との比較 | 差別化 |
